...
// Convert Modal
// ============================================================
const CONVERT_LLM_PROMPT = `I have a web-based Python Recursion Visualizer app. It runs Python in the browser using Pyodide and draws a tree of every recursive call.
...
function copyConvertPrompt() {
    ...
    if (navigator.clipboard && navigator.clipboard.writeText) {
        navigator.clipboard.writeText(CONVERT_LLM_PROMPT).then(onCopied).catch(function () {
            fallbackCopy();
        });
    } else {
        fallbackCopy();
